...
// // // import NavModal from './NavModal'; // Added NavModal
...
// //   const [isSearchModalOpen, setIsSearchModalOpen] = useState(false); // Added search modal state
...
//       <nav 
//         className={`backdrop-blur-md py-4 bg-white/95 z-40 fixed w-full shadow-md transition-transform duration-300 ${
//           visible ? "translate-y-0" : "-translate-y-full"
//         }`}
//       >
//         <div className="max-w-7xl mx-auto px-4">
...
//             {/* Brand Logo - Updated font family */}
//             <Link 
//               href="/" 
//               className="flex items-center"
//               aria-label="Home"
...
//           <div className="p-4 border-b">
//             <div className="flex justify-between items-center">
//               {/* Updated logo font family for mobile */}
